...
import '../../styles/optumModelPerformance.css'
        ...
        {items.map((item) => (
          <div key={item.key} className="ri-model-legend-item" role="listitem">
            <span
              ...
              style={{ '--ri-legend-color': getColor(item.colorToken) } as React.CSSProperties}
            />
...
function OptumIOAModelPerformanceContent({ data }: { data: ModelPerformanceData }) {
